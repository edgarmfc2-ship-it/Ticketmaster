...
events_data = [
    ...
    },
    {
        ...
        "prices": {"general": 150000, "vip": 300000},
        "available_tickets": {"general": 500, "vip": 100}
    },
    {
        "id": "evt005",
        ...
        "prices": {"general": 200000, "vip": 450000},
        "available_tickets": {"general": 1000, "vip": 200}
    },
    {
        "id": "evt006",
        ...
        "prices": {"general": 150000, "vip": 380000},
        "available_tickets": {"general": 80, "vip": 25}
    },
    {
        "id": "evt007",
        "name": "L'Impératrice",
        ...
        "prices": {"general": 180000, "vip": 420000},
        "available_tickets": {"general": 60, "vip": 20}
    },
    {
        "id": "evt008",
        ...
        "prices": {"general": 200000, "vip": 500000, "palco": 900000},
        "available_tickets": {"general": 150, "vip": 40, "palco": 15}
    },
    {
        "id": "evt009",
        ...
        "prices": {"general": 45000, "preferencial": 85000, "palco": 250000},
        "available_tickets": {"general": 500, "preferencial": 200, "palco": 20}
    },
    {
        "id": "evt010",
        "name": "Bloc Party",
        ...
        "prices": {"general": 160000, "vip": 380000},
        "available_tickets": {"general": 70, "vip": 30}
    }
]
...
async def seed_database():
    ...
    print(f"✅ Seeded {len(result.inserted_ids)} events to database")
